...
function Services() {
  ...
  useEffect(() => {
    document.title = 'Massage & Rehabilitation Services Dudley | Renew Body Therapy';
    
    // Update meta description
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Explore expert massage, dry needling, physiotherapy & rehabilitation services in Dudley | Affordable prices, NHS qualified clinician | Book today →');
    }
  }, []);
  ...
  return (
    <div>
      ...
      <div className="services-container">
        ...
        <p>
          This treatment focuses on releasing chronic muscular tension, alleviating tightness, and addressing
          deeper layers of soft tissue. It is ideal for clients with ongoing back, neck, or shoulder pain, or for
          individuals dealing with stress-related muscular tightness.
        </p>
        <p>
          Sessions are delivered in our home clinic, providing a quiet environment that allows for complete
          relaxation while still delivering focused therapeutic work.
        </p>

        <h2>Swedish Massage</h2>
        <p>
          Swedish massage is a gentle and relaxing treatment designed to improve circulation, reduce stress, and
          support overall well-being. It is suitable for all ages and is an excellent choice for clients seeking a
          calming and restorative session.
        </p>

        <h2>Sports Massage</h2>
        <p>
          Sports massage targets specific muscle groups to support recovery, enhance mobility, and prevent
          injury. It is ideal for athletes, gym goers, or anyone managing activity related tension.
        </p>
        <p><strong>Add ons:</strong></p>
        <ul>
          <li>Cupping therapy</li>
          <li>Dry needling or acupuncture style treatment</li>
        </ul>
        <div className="services-buttons">
          <Link to="/services/sports-massage" className="about-btn">Learn More About Sports Massage</Link>
        </div>

        <h2>Stroke Rehabilitation</h2>
        <p>
          Our stroke rehabilitation sessions provide specialist support to help clients rebuild strength,
          coordination, and independence following a stroke. With years of NHS experience in neurology and
          stroke services, we offer practical and effective treatment plans tailored to each patient's capabilities
          and goals.
        </p>

        <h2>Falls Intervention</h2>
        <p>
          Designed for individuals at risk of falls or those recovering from mobility-related incidents, this service
          focuses on improving balance, confidence, and functional movement. It is especially valuable for older
          adults or clients recovering from illness or injury.
        </p>

        <h2>Post-Hospital Discharge Rehabilitation</h2>
        <p>
          For clients returning home after surgery, illness, or prolonged hospital admission, structured
          rehabilitation is essential for safe recovery. We provide step-by-step guidance, mobility training, and
          personalised exercise plans to support a gradual and confident return to daily activities.
        </p>

        <h2>Respiratory &amp; Long Covid Rehabilitation</h2>
        <p>
          These sessions support clients experiencing ongoing breathing difficulties, fatigue, or reduced physical
          capacity following respiratory illness or Long Covid. Treatment includes functional rehabilitation, pacing
          guidance, and safe strengthening exercises.
        </p>

        <h2>Mobile Physiotherapy</h2>
        <p>
          Our mobile physiotherapy services in Dudley and the nearby areas are available for clients who cannot
          travel due to mobility limitations, health concerns, or recovery needs. Sessions are delivered in the
          comfort of your home by a qualified physiotherapist who partners with our clinic.
        </p>

        <h2>Occupational Therapy</h2>
        <p>
          With nearly ten years of NHS occupational therapy experience, we provide expert in-home OT services
          including mobility support, functional assessments, post-injury rehabilitation, and personalised exercise
          plans. This service is ideal for clients recovering from fractures, surgery, or long-term conditions
          affecting daily life.
        </p>

        <h2>Vitamin B12 Injections</h2>
        <p>
          Vitamin B12 injections help support energy levels and overall well-being for individuals with low B12
          levels. This service is delivered safely and professionally at our home clinic.
        </p>

        <h2>Dry Needling</h2>
        <p>
          Dry needling is used to reduce muscle tightness, improve circulation, and relieve pain. It can be offered
          as a standalone service or combined with massage therapy.
        </p>
